...
| 2026-09-14 | nightstand-scale (REEL, 2D motion graphic) | reel-the-rule | nightstand width, visual weight, bedside scale; one-variable before/after showing an undersized nightstand corrected to align with the bed | illustrated bedroom elevation; hero prop: nightstand; no photo seed |
| 2026-09-14 | round-table-flow (REEL, 2D motion graphic) | reel-the-rule | round coffee table, tight-room circulation, walking path; one-variable transformation from a square obstruction to a round table | illustrated compact seating plan; hero prop: coffee table and circulation path; no photo seed |
| 2026-09-14 | door-swing-test (ANIMATED CAROUSEL, sequential still frames) | the-rule | door swing, opening arc, space planning, console collision; practical floor-plan test before buying furniture | illustrated floor plan with progressive door arc and clearance marks; no photo seed |
