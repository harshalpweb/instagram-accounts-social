...
| Investigate `hype_tingles` distribution (2-9 reach across 20 posts, flat since 2026-09-05) | `cto`, escalated by `growth-analyst` | Account-level, not content-level. Unowned for 7 days. |
